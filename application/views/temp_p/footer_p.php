<footer id="footer">
  ...
  <div class="container">
    <div class="copyright">
      &copy; Copyright <strong><span>Kebumen Prima Sarana</span></strong>
    </div>
    <div class="credits">
      <div class="social-links">
        <a href="https://www.tokopedia.com/kpskebumen/" class="twitter"><i class="icofont-owl"></i></a>
        <a href="https://www.facebook.com/profile.php?id=100069813489296" class="facebook"><i class="bx bxl-facebook"></i></a>
        <a href="https://www.instagram.com/kebumenprimasarana_/" class="instagram"><i class="bx bxl-instagram"></i></a>
        <a href="http://shopee.co.id/kpskebumen" class="google-plus"><i class="bx bxl-skype"></i></a>
      </div>
      ...
      Designed by <a href="https://bootstrapmade.com/">Kiwar</a>
    </div>
  </div>
</footer><!-- End Footer -->
