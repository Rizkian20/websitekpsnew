<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form id="form" action="<?= base_url('katalogadmin/editbarang') ?>" method="post">
                <div class="form-group">
                    <label for="nama_barang" style="font-size: 15px">Nama Barang</label>
                    <input name="nama_barang" type="text" class="form-control col-md-12 col-12" id="nama_barang" value="<?= $data_barang['nama_barang'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input name="harga_barang" type="text" class="form-control" id="harga_barang" value="<?= $data_barang['harga_barang'] ?>">
